...
from utils import init_driver, get_last_date_from_csv, log_search_page, keep_scrolling, dowload_images
...
if __name__ == '__main__':
    data = scrap(start_date=start_date, max_date=max_date, words=words, to_account=to_account, from_account=from_account, hashtag=hashtag, interval=interval, lang=lang, headless=headless, limit=limit, display_type=display_type, resume=resume, proxy=proxy, filter_replies=False, proximity=False)
